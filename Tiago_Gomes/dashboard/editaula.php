                  ...
                  <div class="single-table">
                    <form id="editaula" action="editaula.php" method="POST">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="inputtitulo" id="inputtitulo" value="<?= $titulo; ?>" required>
                        <small id="titulo">
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          ...
                          <input type="date" class="form-control" name="inputdata1" id="inputdata1" rows="2" value="<?= $data1; ?>" required>
                          <small id="data">
                            Por favor preencha o campo.
                          </small>
                        </div>
                        <div class="form-group col-md-6">
                          ...
                          <select name="inputhoras" id="inputhoras" class="form-control">
                            <?php
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <select name="inputid_prof" id="inputid_prof" class="form-control" required>
                            ...
                            $sql = "SELECT * FROM professor WHERE especialidade LIKE 'Surfista Instrutor' OR 'Surfista Instrutora';";
                      ...
                      <div class="form-row justify-content-end">
                        <button type="submit" id="submitbtn" class="btn btn-primary" name="editaula">Editar</button>
